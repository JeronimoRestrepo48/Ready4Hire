...
from app.domain.value_objects.interview_mode import InterviewMode, PRACTICE_MODE
...
class Interview:
    ...
    mode: InterviewMode = PRACTICE_MODE  # Modo de entrevista con lógica específica
    ...
    def get_score_average(self) -> float:
        ...
        return sum(a.score.value for a in self.answers_history) / len(self.answers_history)
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "mode": self.mode.to_string() if isinstance(self.mode, InterviewMode) else self.mode,
