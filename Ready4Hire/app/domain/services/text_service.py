...
class TextService:
    ...
    def normalize(
        self, text: str, lowercase: bool = True, remove_accents: bool = True, remove_punctuation: bool = False
    ) -> str:
        """
        Normaliza un texto.
    ...
    def extract_keywords(self, text: str, min_length: int = 3, max_keywords: int = 10) -> list:
        """
        ...
        # Normalizar texto
        normalized = self.normalize(text, lowercase=True, remove_accents=True, remove_punctuation=True)
