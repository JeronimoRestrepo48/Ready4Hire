...
class InterviewAlreadyExists(InterviewDomainException):
    ...
    def __init__(self, user_id: str, existing_interview_id: str):
        super().__init__(
            ...
            details={"user_id": user_id, "existing_interview_id": existing_interview_id},
        )
...
class InterviewNotActive(InterviewDomainException):
    ...
    def __init__(self, interview_id: str, current_status: str):
        super().__init__(
            ...
            details={"interview_id": interview_id, "current_status": current_status},
        )
...
class MaxQuestionsReached(InterviewDomainException):
    ...
    def __init__(self, interview_id: str, max_questions: int):
        super().__init__(
            ...
            details={"interview_id": interview_id, "max_questions": max_questions},
        )
...
class EvaluationError(ServiceException):
    ...
    def __init__(self, message: str):
        super().__init__(message=f"Evaluation Error: {message}", error_code="EVALUATION_ERROR")
...
class EmbeddingsError(ServiceException):
    ...
    def __init__(self, message: str):
        super().__init__(message=f"Embeddings Error: {message}", error_code="EMBEDDINGS_ERROR")
...
class MissingToken(AuthenticationException):
    ...
    def __init__(self):
        super().__init__(message="Authentication token is required", error_code="MISSING_TOKEN")
