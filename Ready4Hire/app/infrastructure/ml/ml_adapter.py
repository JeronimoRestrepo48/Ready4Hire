...
class MLAdapter:
    ...
    def select_question_ml(
        ...
        try:
            ...
            if self.config.enable_clustering:
                selected = self._select_with_clustering(
            ...
            if self._embeddings_available:
                selected = self._select_by_diversity(
                    candidates=candidates,
                    previous_ids=previous_ids
                )
                if selected:
    ...
    def _select_with_clustering(
        ...
        try:
            ...
            # Cluster preguntas
            clusters = self._clustering_service.cluster_questions(
    ...
    def update_performance(
        ...
        try:
            ...
            logger.debug(
                f"Performance update: q={question_id}, "
                f"score={score}, time={time_taken}s"
            )
    ...
    def _init_clustering_service(self) -> None:
        ...
        try:
            ...
            try:
                ...
                logger.warning(
                    "⚠️ Clustering dependencies not available. "
            ...
            from app.infrastructure.ml.advanced_clustering import (
    ...
    def _init_learning_system(self) -> None:
        ...
        try:
            ...
            from app.infrastructure.ml.continuous_learning import (
                ContinuousLearningSystem
            )
            
            self._learning_system = ContinuousLearningSystem(
                storage_dir='.cache/learning',
                exploration_rate=self.config.mab_exploration_rate
            )
